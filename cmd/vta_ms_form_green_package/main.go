...
func main() {
	...
	for i := 0; i < 140; i++ {
		...
		req.Header.Set("X-Correlationid", "d6de8f67-913b-423d-b5cd-832aa8bae0d9")
		...
		req.Header.Set("X-Usersessionid", "0fd14295-b89b-4d4c-a393-259f04d1c5e0")
